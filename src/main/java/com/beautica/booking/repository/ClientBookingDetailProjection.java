 ...
 * names, the master avatar/type, the (nullable) salon name, the discovery locality FK ids,
 * the master address, the service name + category, and a {@code reviewExists} flag from a
 * {@code LEFT JOIN Review}.
 *
