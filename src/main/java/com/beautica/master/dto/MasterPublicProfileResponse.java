 ...
 *
 * <p>Intentionally narrow: only the three fields the endpoint is allowed to modify
 * are echoed back. {@link com.beautica.user.UserProfileResponse} (16 fields) is
 * reserved for the full account-owner self-view ({@code GET /api/v1/users/me})
 * where the wider field set is contextually appropriate.
 *
